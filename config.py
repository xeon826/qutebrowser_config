...
c.content.user_stylesheets = ['~/.config/qutebrowser/adblock.css']
...
c.url.default_page = '~/.config/qutebrowser/Minimal-StartPage/index.html'
# c.url.('url.start_pages', '~/.config/qutebrowser/Minimal-StartPage/index.html')
